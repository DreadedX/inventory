...
protoc --plugin=protoc-gen-twirpscript=../ui/node_modules/twirpscript/dist/compiler.js --twirpscript_out=../ui/src --twirpscript_opt="typescript" --proto_path=../proto handlers/file/file.proto
